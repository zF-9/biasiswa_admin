  ...
  <div class="col-xl-8 col-lg-7">
    ...
    <div class="col-sm-12 col-md-6" style="align:center">
      <div id="dataTable_filter" class="dataTables_filter">
        <label>Nama:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable">
        </label>
      </div>
    </div>
    ...
    <div class="col-sm-12 col-md-6" style="align:center">
      <div id="dataTable_filter" class="dataTables_filter">
        <label>No Kad Pengenalan:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable">
        </label>
      </div>
    </div>  
