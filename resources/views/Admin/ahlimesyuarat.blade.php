             ...
             <div class="col-xl-12 order-xl-2 p-5 bg-white rounded shadow mb-5">
                ...
                <ul id="myTab1" role="tablist" class="col-lg-12 nav nav-tabs nav-pills with-arrow flex-column flex-sm-row text-center">
                  <li class="nav-item flex-sm-fill">
                    <a id="b_pegawai-tab" data-toggle="tab" href="#b_pegawai" role="tab" aria-controls="b_pegawai" aria-selected="true" class="nav-link text-uppercase font-weight-bold mr-sm-3 rounded-0 border active">Luar Negara</a>
                  </li>
                  <li class="nav-item flex-sm-fill">
                    <a id="b_pengajian-tab" data-toggle="tab" href="#b_pengajian" role="tab" aria-controls="b_pengajian" aria-selected="false" class="nav-link text-uppercase font-weight-bold mr-sm-3 rounded-0 border">Dalam Negara</a>
                  </li>
                  <li class="nav-item flex-sm-fill">
