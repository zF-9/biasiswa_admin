              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input name="nokp" type="text" class="form-control form-control-user" id="InputKp" value="{{ $maklumat->nokp }}" maxlength="14" placeholder="">
                    </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      ...
                      <input name="trkhlahir" type="text" class="form-control form-control-user tlahir" id="Inputlahir" value="{{ $maklumat->trkhlahir }}" maxlength="10" placeholder="Tarikh Lahir: xx-xx-xxxx"/>
                    </div> 
                  </div>               
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      <label>Umur</label>
                      <input name="umur" type="text" class="form-control form-control-user inputumur" id="InputUmur" value="{{ $maklumat->umur }}" placeholder="Umur">
                    </div>
                  </div>
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      <label>Taraf Perkahwinan</label>
                        <select name="tarafkahwin" value="" class="form-group form-control-user"  placeholder="">
                ...
                <div class="row">
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="telno" maxlength="12"  type="text" class="form-control form-control-user" id="InputFon" value="{{ $maklumat->telno }}" placeholder="">
                    </div>
                  </div>
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      <label>No. Telefon Pejabat</label>
                      <input name="telnoPej" maxlength="10"  type="text" class="form-control form-control-user" id="InputFonOff" value="{{ $maklumat->telnoPej }}" placeholder="">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-lg-12">
                    <div class="form-group">
                      ...
                      <input name="alamat_1" type="text" class="form-control form-control-user" id="InputAlamat" value="{{ $maklumat->alamat }}" placeholder="Cth: Jalan 1234, Lorong 42">
                ...
                <div class="row">
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      <label>Nama Agensi/Jabatan</label>
                        <select name="jabatan" class="form-group form-control-user" value="{{ $maklumat->jabatan }}" placeholder="Pilih la yang mana satu">
                        <option value="{{ $maklumat->jabatan }}">{{ $maklumat->jabatan }}</option>
                  ...
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="tarikhlantik" type="text" class="form-control form-control-user Tlantik" id="InputTlantik" value="{{ $maklumat->tarikhlantik }}"  placeholder="Tarikh Perlantikan">
                    </div>
                  </div>
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      <label>Tahun Berkhidmat</label>
                      <input name="tberkhidmat" type="text" class="form-control form-control-user inputKhidmat" id="InputTkhidmat" value="{{ $maklumat->tberkhidmat}}" placeholder="Tahun Berkhidmat">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="jawatan" type="text" class="form-control form-control-user" id="InputJawatan" value="{{ $maklumat->jawatan}}"  placeholder="Jawatan">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-lg-0">
                    <div class="form-group">
                      ...
                      <select name="skim" class="form-group form-control-user" id="InputSkim" value="{{ $maklumat->skim}}"  placeholder="Sila Pilih..">
                      <option value="{{ $maklumat->skim}}"> {{ $maklumat->skim }}</option>
                          <option>A</option>
                          <option>AB</option>
                          <option>AL</option>
                          <option>AT</option>
                  ...
                  <div class="form-group col-lg-2">
                    <div class="form-group">
                        <input name="Gred" type="text" class="form-control form-control-user" id="InputGred" value="{{ $maklumat->Gred}}"  placeholder="Gred">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-lg-6">
                    <div class="form-group">
                      ...
                      <select name="TarafLantik" class="form-group form-control-user"  >  
                          <option value="{{ $maklumat->TarafLantik}}">{{ $maklumat->TarafLantik}}</option>
                          <option>Tetap</option>
                  ...
                  <div class="form-group">
                      ...
                      <input  name="Tsahjwtn" type="text" class="form-control form-control-user date" id="InputTsahjwtn" value="{{ $maklumat->Tsahjwtn}}"  placeholder="Tarikh Pengesahan Jawatan">
                    </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="yearpicker form-control form-control-user"   id="year_1"/>
                      <input name="Tahun1LPPT" type="text" class="form-control form-control-user" id="InputT1" value="{{ $maklumat->Tahun1LPPT}}" placeholder="">
                    </div>
                  </div> 
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      <label >Tahun Kedua</label>
                      <input type="text" class="yearpicker form-control form-control-user"  id="year_2"/>
                      <input name="Tahun2LPPT" type="text" class="form-control form-control-user" id="InputT2" value="{{ $maklumat->Tahun2LPPT}}" placeholder="">
                    </div>
                  </div>                  
                  <div class="form-group col-lg-4">
                    <div class="form-group">
                      <label>Tahun Ketiga</label>
                      <input type="text" class="yearpicker form-control form-control-user"  id="year_3"/>
                      <input name="Tahun3LPPT" type="text" class="form-control form-control-user" id="InputT3" value="{{ $maklumat->Tahun3LPPT}}" placeholder="">
                    </div>
                  </div>  
                </div>
